...
<head>
    <meta charset="UTF-8">
    <title>View Service Provider - Admin</title>
    <style>a {text-decoration: none;}</style>
    <link rel="stylesheet" href="/WADAK.com/Implementation/assets/css/ViewServiceProvider-admin.css" type="text/css"/>
...
<div id="mySidenav" class="sidenav">
    ...
    <a href="/WADAK.com/App/view/CoAdmin-profile.php"class="icon-a"><i class="fa fa-users icons"></i> &nbsp;&nbsp;Co-Admin</a>
    ...
    <a href="/WADAK.com/App/view/leaderboard.php"class="icon-a"><i class="fa fa-object-group icons"></i> &nbsp;&nbsp;Leaderboard</a>
        ...
        <div class="inputContainer">
            <div class="form">
                <form>
                    ...
                    <div class="inputbox">
                        <a href="ViewServiceProvider2-admin.html">View</a>
