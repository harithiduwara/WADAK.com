...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/WADAK.com/Implementation/assets/css/addac.css" type="text/css" />
        <link rel="stylesheet"
                    ...
                    <input type="value" placeholder="Achievements ID">
                        ...
                        <div class="inputbox">
                            <table style="width:50%;">
                                <tr>
                                    <td><input type="submit" name="add" value="Add" style="width: 200px !important;">
                                    </td>
