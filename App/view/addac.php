...
<div id="mySidenav" class="sidenav">
    ...
    <a href="/WADAK.com/Implementation/view/news2.php" class="icon-a"><i class="far fa-envelope-open"></i> &nbsp;&nbsp;News</a>
            ...
            &nbsp;&nbsp;Messages</a>
            <a href="/WADAK.com/App/view/complain.php" class="icon-a"><i
...
<div id="main">
    <div class="head">
        <div class="col-div-1">
            <p class="nav">Add Achievements</p>
        </div>
    ...
    <div class="inputContainer" style="margin:auto;width: 50%;">
        <div class="form" style="position: relative;">
            <form action="addcategoryHandle.php" method="POST" enctype="multipart/form-data">
                <div class="inputbox">
                ...
                <div class="inputbox">
                    <input type="text" name="level" required="true" placeholder= "Level">
                </div>
                <div class="inputbox">
