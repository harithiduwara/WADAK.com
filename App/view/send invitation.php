...
<head>
    ...
    <link rel="stylesheet" href="/WADAK.com/Implementation/assets/css/send invitation.css" type="text/css"/>
...
<div class="container">
    <div class="wrapper">
      ...
      <form>
        <img src="programmer.png" alt="user image" class="center" style="width:50px;height:50px; align-items:center;" >
        <div class="row"> 
