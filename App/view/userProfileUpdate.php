            ...
            <div class="col-div-1">
                ...
                <div class="profile">
                    <div class="profile-div">
                        <p><i class="fa fa-user"></i> &nbsp;&nbsp; <a href="/WADAK.com/App/view/userprofile.php?uid=<?= $userData["uid"] ?>">Profile</a>
                        </p>
    ...
    <div class="inputContainer" style="margin:auto;width: 50%; height:60vh">
        <div class="form" style="position: relative;">
            <form action="/WADAK.com/App/controller/updateProfile.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="inputbox">
                    <input type="tel" name="contactno" value="<?= $userData["contactno"] ?>" placeholder=" Contact Nunmber">
                </div>

                <div class="inputbox">
                    <input type="text" name="profileDescription" value="<?= $userData["profileDescription"] ?>" placeholder="Profile Description">
                </div>
                <div>
                    <label for="img" style="color:green">Update Profile Picture</label><br>
                    <div style="text-align:center"> <input type="file" id="fileToUpload" name="fileToUpload" accept="image/*" style="margin-left:5rem"></div>

                </div>

                <div class="inputbox">
                    <input type="url" name="telegram" value="<?= $userData["telegram"] ?>" placeholder="Telegram Link">
                </div>
                <div class="inputbox">
                    <input type="url" name="twitter" value="<?= $userData["twitter"] ?>" placeholder="Twitter Link">
                </div>
                <div class="inputbox">
                    <input type="url" name="instagram" value="<?= $userData["instagram"] ?>" placeholder="Instagram Link">
                </div>
