            ...
            <div class="col-div-6">
                ...
                <div class="profile">
                    ...
                    <div class="profile-div">
                        <a href="/WADAK.com/App/view/userprofile.php?uid=<?= $userData["uid"] ?>">
                            <p><i class="fa fa-user"></i> &nbsp;&nbsp; Profile
                            </p>
                        </a>

                        <a href="/WADAK.com/App/controller/logout.php">
                            <p><i class="fa-duotone fa-arrow-right-from-bracket"></i> &nbsp;&nbsp; Log
                                out
                            </p>
                        </a>
