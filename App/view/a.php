...
<body>
    ...
    <table>
        ...
        $sql = "SELECT Name,Place,Date,Level,A_ID FROM achievements";
        $result = mysqli_query($connection, $sql);
        $out = "";

        while ($data = $result->fetch_assoc()) {
            $out .=  "<tr> <td> <img src='cuplogo.png' class='image' style='width:50px;height:50px;''" .  "</td><td>"   . $data['Name'] .   "</td><td>"  . $data['Place'] . "</td><td>" . $data['Level'] . "</td><td>" . $data['Date'] . "</td></tr>";
        }
        echo $out;
        ?>
</body>
