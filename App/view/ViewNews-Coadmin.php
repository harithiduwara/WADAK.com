...
<head>
  ...
  <link rel="stylesheet" href="/WADAK.com/Implementation/assets/css/ViewNews-Coadmin.css" type="text/css"/>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="/WADAK.com/App/view/ViewServiceProvider-coadmin.php"class="icon-a"><i class="fa fa-users icons"></i> &nbsp;&nbsp;Service Providers</a>
  <a href="/WADAK.com/App/view/categorymain.php"class="icon-a"><i class="fa fa-bullseye icons"></i> &nbsp;&nbsp;Posts</a>
  <!--<a href="accep"class="icon-a"><i class="fa fa-bullhorn icons"></i> &nbsp;&nbsp;Advertisements</a>-->
