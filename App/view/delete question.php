...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/WADAK.com/Implementation/assets/css/delete question.css" type="text/css" />
        <link rel="stylesheet"
    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="#" class="icon-a"><i class="fa fa-tasks icons"></i> &nbsp;&nbsp;Q&A</a>
        </div>

        <div class="container">
            <div class="wrapper">
                <div class="title"><span>Delete Question</span></div>
                <form>
                    <div class="row">
                        Enter Your Password: <input type="password">
                    </div>

                    <button class="button1"> <a href="delete question2.html"> View questions</a></button>
                </form>
            </div>
        </div>
