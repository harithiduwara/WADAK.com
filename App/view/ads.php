...
<html>
    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="/WADAK.com/App/view/Admin-dashboard.html" class="icon-a"><i class="fa fa-dashboard icons"></i>
                &nbsp;&nbsp;Dashboard</a>
            ...
            <a href="/WADAK.com/Implementation/view/Add Coadmin.html" class="icon-a"><i class="fa fa-users icons"></i>
                &nbsp;&nbsp;Add Co-Admin</a>
            <a href="/WADAK.com/App/view/ServiceProviderUI-admin.html" class="icon-a"><i class="fa fa-users icons"></i> &nbsp;&nbsp;Service
                Provider</a>
            <a href="/WADAK.com/App/view/ads.php" class="icon-a"><i class="fa fa-bullhorn icons"></i> &nbsp;&nbsp;Advertisements</a>
            <a href="/WADAK.com/App/view/View Report.html" class="icon-a"><i class="fa fa-envelope icons"></i> &nbsp;&nbsp;Reports</a>
            <a href="/WADAK.com/App/view/PaymentUI.html" class="icon-a"><i class="fa fa-money icons"></i> &nbsp;&nbsp;Payments</a>
