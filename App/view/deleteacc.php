...
<head>
    ...
    <link rel="stylesheet" href="/WADAK.com/Implementation/assets/css/deleteac.css" type="text/css"/>
...
<div id="mySidenav" class="sidenav">
    ...
    <a href="/WADAK.com/App/view/view/news2.php" class="icon-a"><i class="far fa-envelope-open"></i> &nbsp;&nbsp;News</a>
            <a href="/WADAK.com/App/view/messages.php" class="icon-a"><i
