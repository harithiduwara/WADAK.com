...
<head>
    ...
    <link rel="stylesheet" href="/WADAK.com/Implementation/assets/css/userprofile.css" type="text/css"/>
...
<body>
    ...
    <!--
      ...
      <br><h3 style="margin-left: 200px;">More Services By User</h3>
        ...
        <div class="row">
          <div class="column">
            <div class="card1"><img src="code.png" alt="service" style="width:100% ; height:200px">
              <h3>Title</h3>
              <p>I will code program or buld applications in java</p>
              <p><button style="background-color:green;"><i class="fa fa-heart" style="margin-left:200px;"></i></button></p></div>
            </div>
