...
<html>
  ...
  <body>
    <div id="mySidenav" class="sidenav">
      ...
      <a href="accept reject invitation.html" class="icon-a"><i class="fa fa-envelope icons"></i> &nbsp;&nbsp;Invitations</a>
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <form>
          <img src="programmer.png" alt="user image" class="right" style="width:50px;height:50px; align-items:center;">
          <div class="row">
